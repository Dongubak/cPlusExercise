...
//int main14_1(void) {
//
//  char input_fullname[10] = { 0 };
//  printf("enter the string(quit #) : ");
//  while (scanf("%s", input_fullname) == 1 && input_fullname[0] != '#') {
//    printf("%d\n", get_days(input_fullname));
//    printf("enter the string(quit #) : ");
//  }
//  return 0;
//}
...
//  int sum = 0;
//  int i = 0;
//  int input_month = get_index(full_month_name);
//  
//  if (input_month == EOF) {
//    return 0;
//  }
...
//}
//
//int get_index(char* full_month_name) {
//  int i = 0;
//  for (i = 0; i < 12; i++) {
//    if (strcmp(every_month[i].fullname_month, full_month_name) == 0) {
//      return i + 1;
//    }
//  }
//  return EOF;
